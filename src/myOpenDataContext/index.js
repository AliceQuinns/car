        ...
        getMyScore(() => {
            ...
            bg.onload = function () {
                ...
                bg1.onload = function () {
                    ...
                    context.fillText(`${_score}M`, _size.bg1.x + _size.bg1.w / 2, _size.bg.y + (_SIZE.direction ? 120 : 70));
                    // 实际字体
                    context.fillStyle = "#ffffff";
                    context.fillText(`${_score}M`, _size.bg1.x + _size.bg1.w / 2, _size.bg.y + (_SIZE.direction ? 110 : 60));
                    // 最高分
